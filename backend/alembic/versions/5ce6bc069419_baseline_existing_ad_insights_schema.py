...
Do not edit this file once merged — once applied (or stamped) anywhere,
treat it as immutable. Future schema changes are new `alembic revision`
files (append-only), never edits to this one.
"""
